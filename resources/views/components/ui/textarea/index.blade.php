...
@php
    ...
    $classes = [
        ...
        // Shadows and borders
        'disabled:shadow-none border rounded-box',

        // Focus outline
        'focus:ring-2 focus:ring-offset-0 focus:outline-none',

        // Normal state borders and focus rings
        'border-primary/10 focus:border-primary/15 focus:ring-primary/15 dark:border-white/10 dark:focus:border-white/20 dark:focus:ring-neutral-100/15' => !$invalid,

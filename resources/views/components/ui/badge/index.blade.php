...
@php
    if ($variant === 'outline') {
        ...
        $colorClasses = match ($color) {
            ...
            'yellow' => 'text-yellow-800 dark:text-white bg-yellow-100 dark:bg-yellow-400 border-yellow-400 dark:border-yellow-400/90',
            ...
            'rose' => 'text-rose-800 bg-rose-100 dark:bg-rose-200 border-rose-400 dark:border-rose-400/90',
        };
    }

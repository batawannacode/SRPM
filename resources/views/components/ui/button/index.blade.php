...
$colors = match($color) {
    ...
    'emerald' => '[--color-primary:var(--color-emerald-500)] [--color-primary-content:var(--color-emerald-500)] [--color-primary-fg:var(--color-neutral-50)] dark:[--color-primary:var(--color-emerald-500)] dark:[--color-primary-content:var(--color-emerald-400)] dark:[--color-primary-fg:var(--color-neutral-50)]',
...
$variantClasses = match($variant){
    'primary' => [
        'bg-[var(--color-primary)] hover:bg-[color-mix(in_oklab,_var(--color-primary),_black_15%)] hover:translate-y-[-3px] transition-transform duration-200 ease-in-out',
...
$classes = [
    ...
    'rounded-box' => $variant !== 'none' , // Apply rounding unless variant is 'none'

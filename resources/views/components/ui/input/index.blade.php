...
<div {{ $attributes->class(Arr::toCssClasses($classes)) }}>
    ...
    >
        ...
        <input
            @class([
                'z-10',
                'inline-block border py-2.5 px-3 w-full text-base sm:text-sm text-neutral-800 disabled:text-neutral-500 placeholder-neutral-400 disabled:placeholder-neutral-400/70 dark:text-neutral-300 dark:disabled:text-neutral-400 dark:placeholder-neutral-400 dark:disabled:placeholder-neutral-500',
                'bg-white dark:bg-neutral-800 dark:disabled:bg-neutral-800',
                'disabled:cursor-not-allowed transition-colors duration-200',
                'shadow-none dark:shadow-sm disabled:shadow-none rounded-box',
                'focus:ring-2 focus:ring-offset-0 focus:outline-none',
                'border-black/10 focus:border-black/15 focus:ring-primary/50 dark:border-white/15 dark:focus:border-white/20 dark:focus:ring-neutral-100/15' => !$invalid,
